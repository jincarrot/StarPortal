...
class EntityDieAfterEventSignal(EntityEvents):
    ...
    def subscribe(self, callback, options=None):
        ...
        self._events[id(callback)] = EventListener(self.__eventName, callback, options, self._check, "id", EntityDieAfterEvent)
...
class EffectAddAfterEventSignal(EntityEvents):
    ...
    def subscribe(self, callback, options=None):
        ...
        self._events[id(callback)] = EventListener(self.__eventName, callback, options, self._check, "entityId", EffectAddAfterEvent)
...
class EntityHealthChangedAfterEventSignal(EntityEvents):
    ...
    def subscribe(self, callback, options=None):
        ...
        self._events[id(callback)] =  EventListener(self.__eventName, callback, options, self._check, "entityId", EntityHealthChangedAfterEvent)
...
class EntityLoadAfterEventSignal(EntityEvents):
    ...
    def subscribe(self, callback, options=EntityEventOptions):
        ...
        self._events[id(callback)] = EventListener(self.__eventName, callback, options, self._check, "id", EntityLoadAfterEvent)
...
class EntityRemoveAfterEventSignal(EntityEvents):
    ...
    def subscribe(self, callback, options=EntityEventOptions):
        ...
        self._events[id(callback)] = EventListener(self.__eventName, callback, options, self._check, "id", EntityRemoveAfterEvent)
...
class EntitySpawnAfterEventSignal(EntityEvents):
    ...
    def subscribe(self, callback, options=EntityEventOptions):
        ...
        self._events[id(callback)] = EventListener(self.__eventName, callback, options, self._check, "id", EntitySpawnAfterEvent)
...
class DataDrivenEntityTriggerEventSignal(EntityEvents):
    ...
    def subscribe(self, callback, options=EntityEventOptions):
        ...
        self._events[id(callback)] = EventListener(self.__eventName, callback, options, self._check, "entityId", DataDrivenEntityTriggerAfterEvent)
...
class EntityHurtBeforeEventSignal(EntityEvents):
    ...
    def subscribe(self, callback, options=EntityEventOptions):
        ...
        self._events[id(callback)] = EventListener(self.__eventName, callback, options, self._check, "entityId", EntityHurtBeforeEvent)
