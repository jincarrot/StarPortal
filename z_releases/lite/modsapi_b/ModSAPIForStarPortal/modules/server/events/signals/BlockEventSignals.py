...
class BlockExplodeAfterEventSignal(BlockEvents):
    ...
    def subscribe(self, callback, options=None):
        ...
        self._events[id(callback)] = EventListener(self.__eventName, callback, options, self._check, ('dimensionId', 'explodePos'), BlockExplodeAfterEvent)
...
class PlayerBreakBlockAfterEventSignal(BlockEvents):
    ...
    def subscribe(self, callback, options=None):
        ...
        self._events[id(callback)] = EventListener(self.__eventName, callback, options, self._check, ('dimensionId', ('x', 'y', 'z')), PlayerBreakBlockAfterEvent)
...
class PlayerBreakBlockBeforeEventSignal(Events):
    ...
    def subscribe(self, callback, options=None):
        ...
        self._events[id(callback)] = EventListener(self.__eventName, callback, options, self._check, ('dimensionId', ('x', 'y', 'z')), PlayerBreakBlockBeforeEvent)
